...
public class StockSnapShot {
	...
	public long getCurrenAmount() {
		return currenAmount;
	}
	public void setCurrenAmount(long currenAmount) {
	...
	public float getTodayHighestPrice() {
		return todayHighestPrice;
	}
	public void setTodayHighestPrice(float todayHighestPrice) {
		this.todayHighestPrice = todayHighestPrice;
	}
	public float getTodayLowestPrice() {
		return todayLowestPrice;
	}
	public void setTodayLowestPrice(float todayLowestPrice) {
	...
	public float getYesterdayEndPrice() {
		return yesterdayEndPrice;
	}
	public void setYesterdayEndPrice(float yesterdayEndPrice) {
